...
public class ProductScreen {
    ...
    private static void addToCart(Product product, Scanner scanner) throws RuntimeException {
        ...
        if (amount > 0){
            ...
            System.out.print("Add to cart? (Press any to confirm) - (N key to cancel): ");
